...
```{r renm, echo=TRUE, cache=FALSE, tidy=FALSE, include = TRUE}
...
```{r meltCoupon, echo=TRUE, cache=FALSE, tidy=FALSE, include = TRUE}
...
```{r echo=TRUE, cache=FALSE, tidy=FALSE, include = TRUE}
...
```{r getStats, echo=TRUE, cache=FALSE, tidy=FALSE, include = TRUE}
