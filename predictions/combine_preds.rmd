...
```{r cache=FALSE}
   ...
   clspred3 = .45*classification_predictions[,29] + .55*classification_predictions[,11]

    d = data.frame(matrix(clspred3,ncol=3,byrow=TRUE))


   d = matrix(clspred3,ncol=3,byrow=TRUE)
