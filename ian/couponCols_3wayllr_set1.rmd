...
```{r set-parent, echo=FALSE,warning=FALSE,error=FALSE,message=FALSE,cache=TRUE,warning=FALSE,include=FALSE,comment=NA}
   ...
   if(FALSE) 
      rmarkdown::render("/Users/user/dmc2015/ian/couponCols_3wayllr_set1.rmd")
```
...
matrix.a2b1 = lapply(groupA, function(x) 
draw1 = length(c(groupB,groupC1,groupC2,groupD1,groupD2))
t(unique(t(do.call("cbind",lapply(
                                  ,function(x) combn(c(x,groupA),3))))))
