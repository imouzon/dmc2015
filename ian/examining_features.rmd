...
```{r dgg,cache=FALSE}
   f1 = readRDS("~/dmc2015/data/featureMatrix/featMat_based-on-HTVset1_LONG_ver0.1.rds")
   f2 = readRDS("~/dmc2015/data/featureMatrix/featMat_based-on-HTVset2_LONG_ver0.1.rds")
   f3 = readRDS("~/dmc2015/data/featureMatrix/featMat_based-on-HTVset3_LONG_ver0.1.rds")

   d1 = readRDS("~/dmc2015/data/featureMatrix/featMat_based-on-HTVset1_WIDE_ver0.1.rds")
   d2 = readRDS("~/dmc2015/data/featureMatrix/featMat_based-on-HTVset2_WIDE_ver0.1.rds")
   d3 = readRDS("~/dmc2015/data/featureMatrix/featMat_based-on-HTVset3_WIDE_ver0.1.rds")
```
