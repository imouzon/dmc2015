...
<<echo=TRUE, cache=FALSE, include = TRUE>>=
   write.csv(trn,file="~/dmc2015/data/featureMatrix/train_ver1.0.csv",row.names=FALSE,na="",quote=FALSE)
   write.csv(cls,file="~/dmc2015/data/featureMatrix/class_ver1.0.csv",row.names=FALSE,na="",quote=FALSE)
