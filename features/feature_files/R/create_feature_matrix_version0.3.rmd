---
title: Creating Feature Matrix Version 0.3
titleshort: Feature Matrix v. 0.3
instructions: 
output:
  usefulR::DMC_format
---
...
```{r set-parent, echo=FALSE,warning=FALSE,error=FALSE,message=FALSE,cache=TRUE,warning=FALSE,include=FALSE,comment=NA}
   ...
   if(FALSE) 
      rmarkdown::render("/Users/user/dmc2015/features/feature_files/R/feature_matrix_version0.3.rmd")
```
...
makeWideFeatureMatrix = function(w,uf,set){
   ...
   saveRDS(Fmat1,file=paste0("~/dmc2015/data/featureMatrix/featMat_based-on-HTV",set,"_WIDE_ver0.3.rds"))
}
...
makeLongFeatureMatrix = function(l,u,set){
   ...
   Fmat1 = list("train" = trn, "class" = cls, "validation" = val)
   saveRDS(Fmat1,file=paste0("~/dmc2015/data/featureMatrix/featMat_based-on-HTV",set,"_LONG_ver0.3.rds"))
}
```
