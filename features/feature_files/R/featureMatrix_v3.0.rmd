...
```{r nCoupon,cache=FALSE}
   nc = list("train" = read.csv("~/dmc2015/features/feature_files/csv/couponUsed_train.csv"), "class" = read.csv("~/dmc2015/features/feature_files/csv/couponUsed_class.csv"))
```
...
```{r ,cache=FALSE}
  ...
  X.cls = X.cls[,-(which(names(X.cls) == "orderID"))]
```
