...
\pagestyle{fancy}
   \chead{DMC@ISU:\ Feature Matrix v. 0.3}  
   \rhead{\firstxmark}
   \lfoot{\lastxmark}
   \cfoot{}
...
\StringTok{        }\KeywordTok{grepl}\NormalTok{(}\StringTok{"timesUsed_"}\NormalTok{, }\KeywordTok{names}\NormalTok{(f1)))]}
    ...
    \KeywordTok{saveRDS}\NormalTok{(Fmat1, }\DataTypeTok{file =} \KeywordTok{paste0}\NormalTok{(}\StringTok{"~/dmc2015/data/featureMatrix/featMat_based-on-HTV"}\NormalTok{, }
        \NormalTok{set, }\StringTok{"_WIDE_ver0.3.rds"}\NormalTok{))}
\NormalTok{\}}
...
\StringTok{        }\KeywordTok{grepl}\NormalTok{(}\StringTok{"timesUsed_"}\NormalTok{, }\KeywordTok{names}\NormalTok{(f1)))]}
    ...
    \NormalTok{HTV =}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{"~/dmc2015/data/featureMatrix/HTV"}\NormalTok{, set, }\StringTok{".rds"}\NormalTok{))}
    \KeywordTok{names}\NormalTok{(HTV)}
    \KeywordTok{dim}\NormalTok{(HTV$T)}
...
\StringTok{        }\KeywordTok{select}\NormalTok{(orderID, couponUsed, basketValue))}
    ...
    \NormalTok{Fmat1 =}\StringTok{ }\KeywordTok{list}\NormalTok{(}\DataTypeTok{train =} \NormalTok{trn, }\DataTypeTok{class =} \NormalTok{cls, }\DataTypeTok{validation =} \NormalTok{val)}
    \KeywordTok{saveRDS}\NormalTok{(Fmat1, }\DataTypeTok{file =} \KeywordTok{paste0}\NormalTok{(}\StringTok{"~/dmc2015/data/featureMatrix/featMat_based-on-HTV"}\NormalTok{, }
        \NormalTok{set, }\StringTok{"_LONG_ver0.3.rds"}\NormalTok{))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# weichang's features}
\NormalTok{wc3 =}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"../set3/weichangsFeature.rds"}\NormalTok{) %>%}\StringTok{ }\KeywordTok{select}\NormalTok{(-userID)}
\KeywordTok{names}\NormalTok{(wc3)[}\DecValTok{2}\NormalTok{] =}\StringTok{ "weichengProb"}
\NormalTok{s3l =}\StringTok{ }\NormalTok{s3l %>%}\StringTok{ }\KeywordTok{left_join}\NormalTok{(wc3, }\DataTypeTok{by =} \StringTok{"orderID"}\NormalTok{)}
\NormalTok{s3w =}\StringTok{ }\NormalTok{s3w %>%}\StringTok{ }\KeywordTok{left_join}\NormalTok{(wc3, }\DataTypeTok{by =} \StringTok{"orderID"}\NormalTok{)}
