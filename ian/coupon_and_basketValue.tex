...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
   \hlstd{statXcoupon1} \hlkwb{=} \hlstd{statXcoupon} \hlopt{%>%} \hlkwd{renm}\hlstd{(}\hlkwd{c}\hlstd{(}\hlstr{"couponID1"}\hlstd{,}\hlkwd{paste0}\hlstd{(}\hlkwd{names}\hlstd{(statXcoupon)[}\hlkwd{which}\hlstd{(}\hlkwd{names}\hlstd{(statXcoupon)} \hlopt{!=} \hlstr{"couponID"}\hlstd{)],}\hlstr{'.col1'}\hlstd{)))}
   \hlstd{statXcoupon2} \hlkwb{=} \hlstd{statXcoupon} \hlopt{%>%} \hlkwd{renm}\hlstd{(}\hlkwd{c}\hlstd{(}\hlstr{"couponID2"}\hlstd{,}\hlkwd{paste0}\hlstd{(}\hlkwd{names}\hlstd{(statXcoupon)[}\hlkwd{which}\hlstd{(}\hlkwd{names}\hlstd{(statXcoupon)} \hlopt{!=} \hlstr{"couponID"}\hlstd{)],}\hlstr{'.col2'}\hlstd{)))}
   \hlstd{statXcoupon3} \hlkwb{=} \hlstd{statXcoupon} \hlopt{%>%} \hlkwd{renm}\hlstd{(}\hlkwd{c}\hlstd{(}\hlstr{"couponID3"}\hlstd{,}\hlkwd{paste0}\hlstd{(}\hlkwd{names}\hlstd{(statXcoupon)[}\hlkwd{which}\hlstd{(}\hlkwd{names}\hlstd{(statXcoupon)} \hlopt{!=} \hlstr{"couponID"}\hlstd{)],}\hlstr{'.col3'}\hlstd{)))}

   \hlstd{trn.col} \hlkwb{=} \hlstd{trn[,}\hlkwd{c}\hlstd{(}\hlstr{"orderID"}\hlstd{,}\hlstr{"couponID1"}\hlstd{,}\hlstr{"couponID2"}\hlstd{,}\hlstr{"couponID3"}\hlstd{)]}
   \hlstd{trn.col} \hlkwb{=} \hlstd{trn.col} \hlopt{%>%} \hlkwd{left_join}\hlstd{(statXcoupon1,}\hlkwc{by}\hlstd{=}\hlstr{"couponID1"}\hlstd{)}
   \hlstd{trn.col} \hlkwb{=} \hlstd{trn.col} \hlopt{%>%} \hlkwd{left_join}\hlstd{(statXcoupon2,}\hlkwc{by}\hlstd{=}\hlstr{"couponID2"}\hlstd{)}
   \hlstd{trn.col} \hlkwb{=} \hlstd{trn.col} \hlopt{%>%} \hlkwd{left_join}\hlstd{(statXcoupon3,}\hlkwc{by}\hlstd{=}\hlstr{"couponID3"}\hlstd{)}

   \hlkwd{saveRDS}\hlstd{(trn.col,}\hlkwc{file}\hlstd{=}\hlstr{"../features/feature_files/coupon_basket_stats_train_byorder.rds"}\hlstd{)}
   \hlkwd{write.csv}\hlstd{(trn.col,}\hlkwc{file}\hlstd{=}\hlstr{"../features/feature_files/coupon_basket_stats_train_byorder.csv"}\hlstd{,}\hlkwc{quote}\hlstd{=}\hlnum{FALSE}\hlstd{,}\hlkwc{na}\hlstd{=}\hlstr{""}\hlstd{,}\hlkwc{row.names}\hlstd{=}\hlnum{FALSE}\hlstd{)}

   \hlstd{cls.col} \hlkwb{=} \hlstd{cls[,}\hlkwd{c}\hlstd{(}\hlstr{"orderID"}\hlstd{,}\hlstr{"couponID1"}\hlstd{,}\hlstr{"couponID2"}\hlstd{,}\hlstr{"couponID3"}\hlstd{)]}
   \hlstd{cls.col} \hlkwb{=} \hlstd{cls.col} \hlopt{%>%} \hlkwd{left_join}\hlstd{(statXcoupon1,}\hlkwc{by}\hlstd{=}\hlstr{"couponID1"}\hlstd{)}
   \hlstd{cls.col} \hlkwb{=} \hlstd{cls.col} \hlopt{%>%} \hlkwd{left_join}\hlstd{(statXcoupon2,}\hlkwc{by}\hlstd{=}\hlstr{"couponID2"}\hlstd{)}
   \hlstd{cls.col} \hlkwb{=} \hlstd{cls.col} \hlopt{%>%} \hlkwd{left_join}\hlstd{(statXcoupon3,}\hlkwc{by}\hlstd{=}\hlstr{"couponID3"}\hlstd{)}
