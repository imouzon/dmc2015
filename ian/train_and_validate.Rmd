...
<!--- : R code (No Results in Document) -->
```{r cache=FALSE}
   saveRDS(F1,file="~/dmc2015/data/featureMatrix/HTVset1.rds")
   saveRDS(F2,file="~/dmc2015/data/featureMatrix/HTVset2.rds")
   saveRDS(F3,file="~/dmc2015/data/featureMatrix/HTVset3.rds")
```
