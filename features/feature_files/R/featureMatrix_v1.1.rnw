...
<<echo=TRUE, cache=FALSE, include = TRUE>>=
   write.csv(trn,file="~/dmc2015/data/featureMatrix/train_ver1.1.csv",row.names=FALSE,na="",quote=FALSE)
   write.csv(cls,file="~/dmc2015/data/featureMatrix/class_ver1.1.csv",row.names=FALSE,na="",quote=FALSE)

   featMat = list("train" = trn, "class" = cls)
   saveRDS(featMat, file="~/dmc2015/data/featureMatrix/featMat_v1.1.rds")
@
