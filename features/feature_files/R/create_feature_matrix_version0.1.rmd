...
makeWideFeatureMatrix = function(w,uf,set){
   ...
   saveRDS(Fmat1,file=paste0("~/dmc2015/data/featureMatrix/featMat_based-on-HTV",set,"_WIDE_ver0.1.rds"))
}
...
makeLongFeatureMatrix = function(l,u,set){
   ...
   Fmat1 = list("train" = trn, "class" = cls, "validation" = val)
   saveRDS(Fmat1,file=paste0("~/dmc2015/data/featureMatrix/featMat_based-on-HTV",set,"_LONG_ver0.1.rds"))
}
```
